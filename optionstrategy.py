...
.sc-card.expanded{border-color:rgba(0,200,150,.35);box-shadow:0 0 0 1px rgba(0,200,150,.2),0 12px 32px rgba(0,200,150,.12);flex-direction:row;align-items:stretch;max-width:480px;z-index:10;}
